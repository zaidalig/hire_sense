...
# Function to process the resume dataset CSV
def process_resume_dataset_csv(file_path):
...
# --- Define the path to the 'resume_dataset.csv' ---
csv_file_path = './dataset/resume_dataset.csv'  # Adjust to your folder structure

# Process the CSV file
cleaned_data = process_resume_dataset_csv(csv_file_path)

# --- Save the Cleaned Data ---
if not cleaned_data.empty:
    cleaned_data.to_csv('./dataset/cleaned_resume_dataset.csv', index=False)
    print("CSV data preprocessed and saved to 'cleaned_resume_dataset.csv'")
else:
